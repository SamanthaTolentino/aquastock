...
function App() {
  ...
  const fullFishDiv = <div className='flex flex-col items-center xl:w-600px xl:h-350px h-450px'>
        <img className='h-1/2 animate-bounceFish py-2' src={imgPath} alt={filteredFish.length && filteredFish[currentSelection].name} />
          ...
          <div className='bg-blue-1 h-screen flex flex-col items-center justify-center'> 
            <div className='flex items-center mb-4'>
              <div className='opacity-0 animate-fadeInOut justify-self-end w-24 mr-1 scale-x-[-1]'>
                <img className='animate-bounceDownUp' src={fishLogo2} alt='Red fish logo with bouncing animation' />
              </div>     
              <div className='opacity-0 animate-fadeInOut justify-self-start w-24 ml-1'>
                <img className='animate-bounceUpDown' src={fishLogo1} alt='Orange fish logo with bouncing animation' />
              </div>           
            </div>
              ...
              <div className='row-start-3 xl:mb-0 mb-7'>
                <div className='flex justify-center items-center'>
                  <button onClick={goBack} className='mr-5 transition ease-in-out hover:scale-125'>
                    <img className='w-10 animate-wiggleLeft' src={arrowLeft} alt="Left arrow button to go back one" />
                  </button>
                  ...
                  <button onClick={goNext} className='ml-5 transition ease-in-out hover:scale-125'>
                    <img className='w-10 animate-wiggleRight' src={arrowRight} alt="Right arrow button to go forward one" />
                  </button>
                </div>
              </div>
            </div>
